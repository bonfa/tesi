...
\addcontentsline{toc}{chapter}{Sommario}
	...
	\addcontentsline{toc}{section}{Il design del software}
		...
		Ciò è coerente con la natura del compito: infatti è desiderabile che l'architettura cognitiva prenda decisioni riguardanti l'ambiente esterno dopo aver ricevuto ed elaborato tali dati.
