...
\addcontentsline{toc}{chapter}{Estrazione Automatica di Informazione Simbolica Da Immagini}
	...
	\addcontentsline{toc}{section}{Il processo di sviluppo}
		...
		\addcontentsline{toc}{subsection}{Scrum}
			...
			Il Developer Team è composto da programmatori e ha il compito di implementare le nuove funzionalità del prodotto.
			...
			I principali eventi di Scrum sono: \emph{Sprint}, \emph{Sprint Planning Meeting}, \emph{Daily Scrum}, \emph{Sprint Review} e \emph{Sprint Retrospective}.
