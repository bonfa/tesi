...
\end{comment}	
  ...
  \section{OpenCV}
	...
	The following sections contain an introduction to computer vision, a brief history of OpenCV library, a description of its main features and an overview on its architecture. 
