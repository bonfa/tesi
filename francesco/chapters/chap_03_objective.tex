...
\end{comment}
	...
	\section{The Context}
	The work presented in the following sections and chapters is a subset of a research team, whose work aims to make \mbox{ACT-R} see like a human being. As this goal is very ambitious and the author of this document has been introduced in a team with specific sub-goals only for a limited amount of time, he focused on particular tasks. Such tasks are described in the next sections.
	...
	Like most of research projects, this requires an unknown time to produce final results. However, the author of this work has been inserted in this team only for a limited time interval and for this he 

this document describes only the feature developed during this amount of time. The choices made in the 
	
	The team is composed by three people and its aim is to implement known solutions in order to solve specific tasks 


has been developed 

 developed in order to series of tasks that accomplish to specific purposes. Even if this purpose is 
	The work has been developed by a team of three people 
