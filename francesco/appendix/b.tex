...
\section{Tools Used in The Development}\label{appC}
	...
	\begin{itemize}
	    	\item \textbf{Eclipse\footnote{Eclipse:~\url{www.eclipse.org}} CDT} as IDE for writing C and C++ code;
	    	\item \textbf{CUTE\footnote{CUTE:~\url{www.cute-test.com}}} as testing tool;
		\item \textbf{Git\footnote{Git:~\url{www.git-scm.com}}} as distributed version control system;
		\item \textbf{Trac\footnote{Trac:~\url{trac.edgewall.org}}} as web-based project management and bug tracking system;
		\item \textbf{Make\footnote{Make:~\url{www.gnu.org/software/make}}} as build automation tool;
		\item \textbf{Boost\footnote{Boost:~\url{www.boost.org}} library} for managing all the issues related to multithreading;
		\item \textbf{Dia\footnote{Dia:~\url{www.dia-installer.de}}} as tool for creating and reading UML diagrams;
		\item \textbf{cpp2dia\footnote{cpp2dia:~\url{cpp2dia.sourceforge.net}}} as tool for creating authomatically UML diagrams from source code;
	\end{itemize}	
