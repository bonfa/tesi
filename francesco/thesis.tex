...
\usepackage[italian,english]{babel}	%l?ultima lingua é quella predefinita
...
\newcommand\SectionFontStyle{\rmfamily}			% gehört zu den beiden folgenden setkomafont , keine ahnung was es macht =)
...
\mbox{}
	...
	\input{beginningEnding/introITA.tex}
	...
	\input{chapters/chap_01_introduction.tex}
	\newpage
	\input{chapters/chap_02_state_of_the_art.tex}
	\newpage
	\input{chapters/chap_03_objective.tex}
	\newpage
	\input{chapters/chap_04_development_process.tex}
	\newpage
	\input{chapters/chap_05_design.tex}
	\newpage
	\input{chapters/chap_06_implementation_and_testing.tex}
	\newpage
	\input{chapters/chap_07_conclusions.tex}
